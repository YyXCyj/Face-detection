...
pretrained_settings = {
    'se_resnet50': {
        True: {
            # 'url':'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/seresnet50_a3_0-317ecd56.pth',#a3
            'url': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',#resnet-50
            # 'url':'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/seresnet50_ra_224-8efdb4bb.pth',
            'input_space': 'RGB',
            'input_size': [3, 840, 840],
            'input_range': [0, 1],
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(self.se_module(out).shape)
...
class SEResNetBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        # self.bn2 = nn.LayerNorm(planes, eps=1e-6)
        #
        ...
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=7, padding=3,
